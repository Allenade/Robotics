    ...
    <div className="p-8 max-w-4xl space-y-8">
      ...
      <section>
        ...
        <p className="mt-2 italic">
          Like learning to drive – you need to know the basics before you can
          navigate traffic.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Inverse Kinematics:</strong> A surgical robot figuring out
            the exact angles its joints must take to reach a target inside the
            patient.
          </li>
        </ul>
        <p className="mt-2 italic">
      ...
      <section>
        ...
        <p>
          Understanding all the forces acting on a robot and how they affect
          movement.
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>Gravity:</strong> A robotic arm lifting car parts must
            overcome downward pull.
          </li>
          <li>
            <strong>Friction:</strong> Walking robots need grip to avoid
            slipping, while warehouse robots deal with smooth floors.
          </li>
          <li>
            <strong>External forces:</strong> Construction robots must resist
            wind.
          </li>
          <li>
            <strong>Mars rovers:</strong> Engineers account for lower gravity on
            Mars when programming wheel force.
          </li>
        </ul>

        <h3 className="mt-4 font-semibold">Control</h3>
        <p>Systems that adjust robot movements in real time.</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>Drone stabilization against wind.</li>
          <li>
            Walking robots (e.g. Boston Dynamics Atlas) keeping balance on
            uneven terrain.
          </li>
          <li>Prosthetic limbs applying precise grip force.</li>
      ...
      <section>
        ...
        <p>
          ...
          environment, and plan their actions.
        </p>
        <h3 className="mt-3 font-semibold">Real-world applications:</h3>
        <ul className="list-disc pl-6 space-y-2">
          <li>Self-driving cars detecting pedestrians and planning routes.</li>
          <li>Amazon warehouse robots scanning and navigating shelves.</li>
          <li>Robot vacuums mapping homes and planning cleaning paths.</li>
          <li>Search and rescue robots navigating rubble to find survivors.</li>
          <li>Mars rovers exploring terrain and collecting samples.</li>
        </ul>
        <p className="mt-2 italic">
          Like being dropped in a new city — figure out where you are, where you
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Personal assistants adjusting home temperature, lighting, and music.
          </li>
          <li>
            Agricultural robots identifying ripe vs unripe crops for harvesting.
          </li>
          <li>
            Security robots learning suspicious vs. normal patterns in malls.
          </li>
        </ul>
        <p className="mt-2 italic">
          Like the difference between following a recipe exactly vs. being a
          chef who can adapt.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Imagine a <strong>robot chef</strong> in a restaurant:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
